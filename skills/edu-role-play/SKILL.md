...
- [SCORM docs](https://github.com/minicoursegenerator/edu-role-play/blob/main/docs/scorm.md) — what the SCORM 1.2 runtime reports to the LMS (cmi.* fields, suspend_data shape, limitations)
